...
namespace ApiProjeKampi.WebApi.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        public IActionResult CreateProductWithCategory(CreateProductDto dto)
        {
            var mappedValue = _mapper.Map<Product>(dto);
            _context.Products.Add(mappedValue);
            _context.SaveChanges();
        ...
        public IActionResult ProductListWithCategory()
        {
            ...
            var mappedValue = _mapper.Map<List<ResultProductWithCategoryDto>>(value);
